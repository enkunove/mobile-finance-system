...
class ManagerTransferLogScreen extends StatefulWidget {
  const ManagerTransferLogScreen({super.key});

  @override
  State<ManagerTransferLogScreen> createState() =>
      _ManagerTransferLogScreenState();
}

class _ManagerTransferLogScreenState extends State<ManagerTransferLogScreen> {
